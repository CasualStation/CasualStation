/datum/weather/royale
	telegraph_message = "<span class='userdanger'><i>The storm is closing in, get away from the edge!</i></span>"
...
/datum/weather/royale/three
	...
	telegraph_message = "<span class='userdanger'><i>The storm is closing in, get away from the east!</i></span>"
...
/datum/weather/royale/four
	...
	telegraph_message = "<span class='userdanger'><i>The storm is closing in, get away from the south!</i></span>"
...
/datum/weather/royale/six
	...
	telegraph_message = "<span class='userdanger'><i>The storm is closing in, make your final stand!</i></span>"
